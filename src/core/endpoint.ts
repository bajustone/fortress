 ...
 * typed `fortress.call.*` proxy). None of them exist at runtime.
 *
 ...
 * captures the literal handler name so `definePlugin` can verify it against
 * the plugin's method surface.
 */
