...
type TenancyRoutes = {
  readonly createTenant: EndpointDefinition<
    ...
    'createTenant'
  >;
  readonly deleteTenant: EndpointDefinition<{}, {}, { id: string }, { 200: { ok: boolean } }, 'deleteTenant'>;
  readonly getMyTenants: EndpointDefinition<{}, {}, {}, { 200: { tenants: JsonOf<TenantRecord>[] } }, 'getMyTenants'>;
  readonly switchTenant: EndpointDefinition<{ taxId: string }, {}, {}, { 200: { ok: boolean } }, 'switchTenant'>;
};
...
export function tenancy(config: TenancyConfig & { routes: true }): TenancyPlugin & { routes: TenancyRoutes };
